...
4. **Semantic — the LLM judge / 语义层 · 大模型判官** — off-topic answers the rules
   can't settle. （规则判不了的“答非所问”，交给大模型判官。）
...
| 答非所问 Off-topic（LLM 判官） | 答案与问题无关 | 大模型语义判断 |
...
tools to solve real business problems. Cleanvey began as my **award-winning entry**
to an internal company AI hackathon; this public
